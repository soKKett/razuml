...
<head>
	...
	<?php
								...
								$res_array1 = mysqli_fetch_row($result1);
								$res_array2 = mysqli_fetch_row($result2);
								$res_array3 = mysqli_fetch_row($result3);
								$res_array4 = mysqli_fetch_row($result4);
								mysqli_close($conn);
								$imp_news_1 = $res_array1['0'];
								$imp_news_2 = $res_array2['0'];
								$imp_news_3 = $res_array3['0'];
								$imp_news_4 = $res_array4['0'];
		?>
	...
	<div class="container bloc-lg">
		<div class="row">
			<div class="col-md-6 order-lg-0 offset-lg-0">
				<a href="#" class="btn adm-btn btn-white-2 btn-lg float-lg-none none btn-block" data-toggle="modal" data-target="#modal-40867">Добавить новость<br></a>
				<div class="divider-h">
			...
			<div class="col-md-6">
				<div>
					<a href="#" class="btn btn-lg btn-block adm-btn btn-white-2" data-toggle="modal" data-target="#ffsdffsd">Изменить список важных новостей</a>
					<div class="divider-h">
						<span class="divider"></span>
					</div>
				</div>
			...
			<div class="col-md-6">
				<a href="#" class="btn btn-lg adm-btn btn-white-2 float-lg-none btn-block" data-toggle="modal" data-target="#modal-21049">Редактировать новости</a>
			</div>
		</div>
	</div>
</div>
					...
					<div class="modal-dialog modal-fill modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="form_3" data-form-type="blocs-form" novalidate data-success-msg="Your message has been sent." data-fail-msg="Sorry it seems that our mail server is not responding, Sorry for the inconvenience!" action="editnews.php" method="POST">
								<select class="form-control" name="editarticle">
									<?php foreach ($mainres as $v) {
						...
						<div class="rwer modal-content">
							...
							<div class="modal-body">
						       ...
						       <select class="form-control" id="impnews-1" name="impnews-1">
									<option value="<?=$imp_news_1;?>">
									<?=$imp_news_1;?>
									</option>
									<?php
									foreach ($mainres as $v) {
										echo
										'<option value="'.$v['headliner'].'">
										'.$v['headliner'].'
										</option>';
										}
									;?>
				...
				<div id="modal-40867" class="modal fade" tabindex="-1" role="dialog">
					<div class="modal-dialog modal-fill modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="form_1" data-form-type="blocs-form" novalidate data-success-msg="Your message has been sent." data-fail-msg="Sorry it seems that our mail server is not responding, Sorry for the inconvenience!" action="newsadd.php" method="POST">
									...
									<div class="form-group container-div-style">
										...
										<input id="description" class="form-control field-bloc-26-style formstyle" required name="description" />
									</div>
									<div class="form-group">
